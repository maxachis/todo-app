...
Backend model and API for the contact draft inbox, enabling quick capture of contacts from notebook pages with a triage workflow for promoting drafts to full Person or Organization records.
