...
System-managed Inbox list that serves as the default capture location for tasks, always appearing first in the sidebar and protected from renaming, deletion, and drag reordering.
