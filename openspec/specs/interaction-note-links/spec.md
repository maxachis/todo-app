# Interaction Note Links

## Purpose

Bidirectional linking between CRM interactions and notebook pages, with explicit join-table links managed via API and displayed in both the interaction detail panel and notebook editor.
