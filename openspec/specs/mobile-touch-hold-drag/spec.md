...
Defines the touch-hold gesture gate for drag-and-drop on mobile/touch devices, requiring a sustained touch before drag activation to prevent accidental drags during scrolling and tapping.
