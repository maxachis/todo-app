...
Models and API for linking notebook pages to entities (people, organizations, tasks, projects) and to other pages, with backlink support for bidirectional navigation.
